<form method="POST" action="/admin/products/items{{ isset($data) ? '/' . $data->id : '' }}" enctype="multipart/form-data">
    ...
    <div class="card mt-3">
        <div class="card-header"><a href="/admin/products/items">{{ __('products.title') }}</a> /
            {{ isset($data) ? __('global.update') : __('global.add_new_record') }}
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <select class="form-select form-select-sm select @error('product_category_id') is-invalid @enderror" id="product_category_id" name="product_category_id">
                                ...
                                @if ($cat->parent_id == 0)
                                <option value="{{ $cat->id }}" {{ isset($data) ? ($data->parent_id == $cat->id ? 'selected' : '') : '' }}>
                                    {{ $cat->name }}
                                </option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control form-control-sm @error('slug') is-invalid @enderror" id="slug" name="slug" disabled value="{{ isset($data) ? $data->slug : old('slug') }}" />
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control form-control-sm date @error('expiry_date') is-invalid @enderror" id="expiry_date" name="expiry_date" />
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6 row">
                            <label for="sales_commission_item" class="col-md-7">{{ __('products.fields.sales_commission_item') }}</label>
                            <div class="col-md-5">
                                <div class="form-check">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <select class="form-select form-select-sm select @error('purchase_tax_type') is-invalid @enderror" id="purchase_tax_type" name="purchase_tax_type">
                                <option value="" disabled>{{ __('global.pleaseSelect') }}</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <select class="form-select form-select-sm select @error('sales_tax_type') is-invalid @enderror" id="sales_tax_type" name="sales_tax_type">
                                <option value="" disabled>{{ __('global.pleaseSelect') }}</option>
                                @foreach (__('accounting_lookup.tax_types') as $k => $v)
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control form-control-sm @error('viewed') is-invalid @enderror" id="viewed" name="viewed" value="{{ isset($data) ? $data->viewed : old('viewed') }}" disabled />
