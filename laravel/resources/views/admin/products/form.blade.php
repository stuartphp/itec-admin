        ...
        <div class="card">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <select
                                    class="form-select form-select-sm select @error('product_category_id') is-invalid @enderror"
                                    id="product_category_id" name="product_category_id">
                                    <option value="" disabled>{{ __('global.pleaseSelect') }}</option>
                                    @foreach ($categories as $cat)
                                        @if ($cat->parent_id == 0)
                                            <option value="{{ $cat->id }}"
                                                {{ isset($data) ? ($data->parent_id == $cat->id ? 'selected' : '') : '' }}>
                                                {{ $cat->name }}</option>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input type="text"
                                    ...
                                    name="barcode" value="{{ isset($data) ? $data->barcode : old('barcode') }}" />
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <select class="form-select form-select-sm select @error('unit') is-invalid @enderror"
                                    id="unit" name="unit">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3 row">
                            <div class="col-md-6 row">
                                <label for="allow_tax" class="col-md-7">{{ __('products.fields.allow_tax') }}</label>
                                <div class="col-md-5">
                                    <div class="form-check">
                                        <input type="checkbox"
                                            class="form-check-input @error('allow_tax') is-invalid @enderror" id="allow_tax"
                                            name="allow_tax" />
                                    </div>
                            ...
                            <div class="col-md-6 row">
                                <label for="sales_commission_item"
                                    class="col-md-7">{{ __('products.fields.sales_commission_item') }}</label>
                                <div class="col-md-5">
                                    <div class="form-check">
                                        <input type="checkbox"
                        ...
                        <div class="mb-3 row">
                            <label for="purchase_tax_type"
                                class="col-md-3">{{ __('products.fields.purchase_tax_type') }}</label>
                            <div class="col-md-9">
                                <select
                                    class="form-select form-select-sm select @error('purchase_tax_type') is-invalid @enderror"
                        ...
                        <div class="mb-3 row">
                            <label for="sales_tax_type"
                                class="col-md-3">{{ __('products.fields.sales_tax_type') }}</label>
                            <div class="col-md-9">
                                <select
                                    class="form-select form-select-sm select @error('sales_tax_type') is-invalid @enderror"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input type="text"
                                    class="form-control form-control-sm @error('viewed') is-invalid @enderror" id="viewed"
                                    name="viewed" value="{{ isset($data) ? $data->viewed : old('viewed') }}" disabled />
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <img src="/images/products/{{ isset($data->main_image) ? ($data->main_image>0) ? $data->main_image : '' :'no-image.jpg' }}" style="height: 200px"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3 row">
                            <label for="is_feature" class="col-md-6">{{ __('products.fields.is_feature') }}</label>
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input type="checkbox"
                                        class="form-check-input @error('is_feature') is-invalid @enderror" id="is_feature"
                                        name="is_feature" />
                                </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3 row">
                            <label for="is_service" class="col-md-6">{{ __('products.fields.is_service') }}</label>
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input type="checkbox"
                                        class="form-check-input @error('is_service') is-invalid @enderror" id="is_service"
                                        name="is_service" />
                                </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3 row">
                            <label for="is_active" class="col-md-6">{{ __('products.fields.is_active') }}</label>
                            <div class="col-md-6">
                                <div class="form-check">
                    ...
                    <div class="col-md-3"><div class="text-end"><button class="btn btn-outline-primary btn-sm" type="submit">{{ __('global.save') }}</button></div></div>
                </div>
            </div>
        </div>
    </form>
